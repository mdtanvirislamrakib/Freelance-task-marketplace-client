...
const HowItWorksSection = () => {
  ...
  const handleGetStarted = () => {
    navigate('/browse-tasks'); // Or '/add-task' depending on your preference
  };
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          <button 
            ...
            className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer"
          >
            Get Started Now
          </button>
        </motion.div>
